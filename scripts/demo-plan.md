...
- Aspiration linking
- Projects with phases and photos
- Moments (spontaneous captures)
- AI features
...
- **Target:** 10 minutes
- **Aspiration:** Be Present & Mindful
- **Activities:** 20 logs over 4 weeks
  - Week 1: 5, 7, 10, 8 min (4 days)
  - Week 2: 10, 12, 10, 15, 10 (5 days)
  - Week 3: 15, 15, 20, 15 (4 days)
  - Week 4: 20, 20, 15, 20, 25, 20, 22 (7 days)
- **Resistance Examples:**
  - "Too tired" (fatigue, 2x)
  - "Too busy" (time, 1x)
...
- **Activities:** 18 logs
  - Week 1: 10, 15, 12 (3 days)
  - Week 2: 15, 20, 18, 25 (4 days)
  - Week 3: 25, 30, 28, 35 (4 days)
  - Week 4: 35, 40, 42, 45, 48, 50, 52 (7 days - showing steady increase!)
- **Resistance Examples:**
  - "Arms sore from yesterday" (physical, 2x)
  - "Don't feel like it" (motivation, 1x)
  - None (15x)
...
- **Aspiration:** Be Present & Mindful
- **Activities:** 15 logs
  - Mix: 1.5, 2.0, 1.8, 2.5, 2.0, 1.7, 2.2, 2.0, 2.3, 2.0, 1.9, 2.5, 2.0, 2.4, 2.1
...
- **Metric:** Duration (minutes)
- **Target:** 30
- **Aspiration:** Strengthen Relationships
- **Activities:** 4 logs (weekly)
  - 45, 60, 35, 50 (Sundays)
...
## 5. STELA/MOMENTS MESSAGES (Show AI in action)
...
4. Show resistance tracking (none today!)
...
4. Show progression chart (10 → 52 reps)
5. Show trend: ↗️ Improving
...
4. Demo AI: "Get better at cooking healthy meals"
...
4. Show Top Performing Habits (bar chart)
5. Show Projects section with photos
...
3. Show tech stack
4. Show honest analysis section
...
6. **User:** Record with Playwright video
7. **User:** Add voice overlay with voice generation tool

---

## Voice Generation Tool Options

- **ElevenLabs** - Very natural, free tier available
- **Microsoft Azure Text-to-Speech** - Already using Azure
- **Google Cloud Text-to-Speech** - Natural voices
- **Play.ht** - Good quality, free tier
- **Murf.ai** - Professional quality

**Recommended:** ElevenLabs for most natural voice, or Azure TTS (already have account)
